...
$sql = "SELECT * FROM cita WHERE puertaEntrada='Puerta 1 Revolución' AND diaEntrada = '$fechaActual' AND horaEntrada >= '$horaLimiteAntes' AND horaEntrada <= '$horaLimiteDespues'";
