...
$sql = "SELECT * FROM cita WHERE puertaEntrada='Puerta 2 Olimpica' AND diaEntrada = '$fechaActual' AND horaEntrada >= '$horaLimiteAntes' AND horaEntrada <= '$horaLimiteDespues'";
